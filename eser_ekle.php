    ...
    <h2>Eser Ekleme Formu</h2>
        <form method="post" action="eser_ekle2.php">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="formControl1">
            </div>
            <div class="mb-3">
                <label for="formControl2" class="form-label">Eser Özeti</label>
                <textarea class="form-control" id="formControl2" rows="3"></textarea>
            </div>
            <div class="mb-3">
                <label for="formControl1" class="form-label">Eser URL</label>
                <input type="text" class="form-control" id="formControl3">
            </div>
